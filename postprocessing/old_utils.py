...
def get_credible_level_scipy(samples, injected_value, circular=False):
    """
...
def get_true_params_and_credible_level(chains: np.array, 
                                       ...
                                       which_percentile_calculation="one_sided") -> tuple[np.array, float]:
    """
    ...
    for i, true_params in enumerate(true_params_list):
        ...
        for j, param in enumerate(true_params):
            ...
            if which_percentile_calculation =="one_sided":
                ...
                credible_level = get_credible_level_scipy(chains[:, j], param)
