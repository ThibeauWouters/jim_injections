...
data_path = "/home/twouters2/jim_injections/real_events/data_GW170817" # without slash
outdir = "/home/twouters2/jim_injections/real_events/GW170817_TaylorF2/outdir/" # without slash
...
if load_online_data:
    ...
    H1.load_psd_from_file(f'{data_path}/GW170817-IMRD_data0_1187008882-43_generation_data_dump.pickle_H1_psd.txt')
    L1.load_psd_from_file(f'{data_path}/GW170817-IMRD_data0_1187008882-43_generation_data_dump.pickle_L1_psd.txt')
    V1.load_psd_from_file(f'{data_path}/GW170817-IMRD_data0_1187008882-43_generation_data_dump.pickle_V1_psd.txt')
