...
my_device = '0' # select GPU index to use
...
# from flowMC.utils.postprocessing import plot_summary # TODO needs to be fixed first
# ripple
...
def body(N: str, outdir: str, load_existing_config: bool = False) -> None:
    ...
    local_sampler_arg = {'step_size': mass_matrix * 1e-5} # set the overall step size
...
def main():
    ...
    body("GW170817", outdir = OUTDIR, load_existing_config = True) 
